package com.ampuero.msvc.inventario.exceptions;

import com.ampuero.msvc.inventario.dtos.ErrorDTO;
...
/**
 * GlobalExceptionHandler para msvc-inventario
 * Maneja todas las excepciones del microservicio de inventario
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handleInventarioException(InventarioException ex) {
    ...
    public ResponseEntity<ErrorDTO> handleGenericException(Exception ex) {
        Map<String, String> errorMap = Collections.singletonMap("error", "Error interno del servidor: " + ex.getMessage());
        LocalDate localDate = LocalDate.now();
    ...
    public ResponseEntity<ErrorDTO> handleIllegalArgumentException(IllegalArgumentException ex) {
        Map<String, String> errorMap = Collections.singletonMap("error", "Argumento inválido: " + ex.getMessage());
        LocalDate localDate = LocalDate.now();
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(this.createErrorDTO(HttpStatus.BAD_REQUEST.value(), localDate, errorMap));
    }
    ...
    public ResponseEntity<ErrorDTO> handleNullPointerException(NullPointerException ex) {
        Map<String, String> errorMap = Collections.singletonMap("error", "Error de referencia nula en el inventario");
        LocalDate localDate = LocalDate.now();
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(this.createErrorDTO(HttpStatus.INTERNAL_SERVER_ERROR.value(), localDate, errorMap));
    }
